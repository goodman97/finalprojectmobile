...
import 'package:finalproject/features/auth/screens/user/game_hub.dart'; // ← ganti dari minigame
...
class _ScreenState extends State<Navigation> {
  ...
  final List<Widget> pages = const [
    ...
    MyTickets(),
    Market(),
    GameHub(),  // ← ganti dari MiniGame() ke GameHub()
    Profile(),
  ];
    ...
    return Transform.translate(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: const Color(0xFFE4572E).withOpacity(0.12),
